    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach(string str in inputs)
            {
                ...
                Regex regex = new Regex(@"\\x[0-9a-fA-F][0-9a-fA-F]");
                ...
                thisLiteral += temp.Length;
                thisMemory += temp.Length;
                thisEncoded += temp.Length;
